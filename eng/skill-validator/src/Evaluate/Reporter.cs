...
public static class Reporter
{
        ...
        string? judgeModel = null)
    {
        ...
        if (anyFailure)
            sb.AppendLine("\n> 📖 See [InvestigatingResults.md](https://github.com/dotnet/skills/blob/main/eng/skill-validator/InvestigatingResults.md) for how to diagnose failures. Additional debugging guidance may be provided by your workflow.");
